...
class TradeLog:
    ...
    def append_trades(self, trades: List[Dict[str, Any]]) -> int:
        if not trades:
            return 0
...
def process_once(
    ...
    added = trade_log.append_trades(trade_records)
    if added:
        print(f"[INFO] Registradas {added} operaciones nuevas (total={trade_log.registered_trades}).")
