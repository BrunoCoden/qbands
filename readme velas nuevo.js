readme velas nuevo
velas_tv_sin_sdk.py ===> script_principal_de_velas_solo_bandas.py
grafico_live.py ===> grafico_de_script_principal_solo_bandas.py
stream_table.csv ===> tabla.csv
alertas_desde_csv.py ===> alertas_q_band.py

ahora a mi archivo soloAlertas.py necesito que le agreguemos la funcionalidad de la tabla csv al igual que tenia en mi archivo de stream_table.csv que se va a llamar tabla.csv



ahora te voy a pasar el script de alertas viejo y necesito que me generes uno nuevo que se va a llamar "alertaSinSenal" que hace lo mismo (con eso me refiero a los avisos de telegram) pero para soloAlertas.py, pero necesito que en este caso me vaya loguean las alertas en tiempo real y no a vela cerrada como hace este script
